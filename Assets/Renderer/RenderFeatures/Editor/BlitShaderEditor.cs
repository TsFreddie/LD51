using UnityEditor;
using UnityEngine;
[CustomPropertyDrawer(typeof(BlitShader.BlitSettings))]
public class BlitEditor : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        EditorGUILayout.PropertyField(property.FindPropertyRelative("targetTexture"));
        ...
        if (enumValue == (int)BlitShader.Target.TextureID)
        {
            EditorGUILayout.PropertyField(property.FindPropertyRelative("srcTextureId"));
        }
        else if (enumValue == (int)BlitShader.Target.RenderTextureObject)
        {
