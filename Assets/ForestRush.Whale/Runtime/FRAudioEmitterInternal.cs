...
{
    internal class FRAudioEmitterInternal : MonoBehaviour
    {
        private Transform _attachedTransform;
        private bool _nonTracked;
        private FRAudioEvent _event;

        internal AudioSource AudioSource { get; private set; }

        internal int Id { get; private set; }
        internal Action<FRAudioEmitterInternal> OnEmitterStop;
        ...
        internal void SetEvent(FRAudioEvent ev)
        {
            _event = ev;
            if (_event != null)
        ...
        internal static FRAudioEmitterInternal Create(Transform parent)
        {
            var go = new GameObject("AudioEmitter");
            go.SetActive(false);
            var emitter = go.AddComponent<FRAudioEmitterInternal>();
